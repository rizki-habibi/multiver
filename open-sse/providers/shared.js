...
// Keep this static even when Multiver runs on Linux: the provider profile is
...
// Antigravity OAuth client credentials (loaded from env to pass GitHub Push Protection)
export const ANTIGRAVITY_OAUTH_CLIENT = {
  clientId: process.env.ANTIGRAVITY_CLIENT_ID || "",
  clientSecret: process.env.ANTIGRAVITY_CLIENT_SECRET || ""
};

// Gemini (Google) OAuth client credentials (loaded from env to pass GitHub Push Protection)
