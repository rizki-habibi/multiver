 ...
 * API. They are Multiver fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic Multiver variant set for a single upstream Kiro model.
 *
 ...
 * into Multiver variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
