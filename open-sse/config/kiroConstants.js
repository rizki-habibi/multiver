 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Multiver needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a Multiver
 ...
 * The suffix is a Multiver request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a Multiver synthetic agentic variant.
...
/**
 * Detect whether a model id is a Multiver synthetic thinking variant
...
/**
 * Resolve a Multiver model id to the real upstream Kiro model id, plus flags
