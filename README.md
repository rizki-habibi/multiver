...
Advanced Multi-AI Fusion Router.
...
- **Multimodal (v6)**: Teks, gambar, audio, dan dokumen ditangani sesuai kemampuan model. Permintaan otomatis dialihkan ke model yang mendukung kemampuan yang dibutuhkan.
