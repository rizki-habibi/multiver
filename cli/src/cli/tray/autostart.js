...
const APP_LABEL = "com.multiver.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when multiver is currently
 ...
 * SIGTERM to the running process. When the running multiver cli.js was itself
...
<dict>
    ...
    <string>/tmp/multiver.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/multiver.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `multiver.cmd` lookup that depended on the npm prefix path.
