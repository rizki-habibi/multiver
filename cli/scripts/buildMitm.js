...
const cliAppDir = process.env.MULTIVER_CLI_APP_DIR || process.env.NINEROUTER_CLI_APP_DIR || path.join(cliDir, "app");
...
// node_modules file locks that block `npm i -g multiver@latest` on Windows).
const EXTERNALS = [];
