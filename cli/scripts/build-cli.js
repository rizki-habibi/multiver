...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/multiver/server.js.
...
function buildCliPackage() {
  console.log("📦 Building Multiver CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.multiver/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.multiver/runtime)");
  }
  console.log("");
