# Multiver — Agent Skills

Drop-in skills for any AI agent (Claude, Cursor, ChatGPT, custom SDK). Just **copy a link** below and paste it to your AI — it will fetch the skill and use Multiver for you.

> Tip: start with the **Multiver** entry skill — it covers setup and links to all capability skills.

## Skills

| Capability | Copy link below and paste to your AI |
|---|---|
| **Entry / Setup** (start here) | https://raw.githubusercontent.com/decolua/Multiver/refs/heads/master/skills/Multiver/SKILL.md |
...
| Video generation (xAI Grok Imagine) | https://raw.githubusercontent.com/decolua/Multiver/refs/heads/master/skills/Multiver-video/SKILL.md |
...
```
Read this skill and use it: https://raw.githubusercontent.com/decolua/Multiver/refs/heads/master/skills/Multiver/SKILL.md
```
...
```bash
export MULTIVER_URL="http://localhost:20222"   # local default, or your VPS / tunnel URL
...
- Source: https://github.com/decolua/Multiver
- Dashboard: https://Multiver.com
