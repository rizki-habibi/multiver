...
export const metadata = {
  title: "Multiver - AI Infrastructure Management",
  description: "Multiver: Advanced Multi-AI Fusion Router. One endpoint for all providers, parallel fusion, and auto-failover.",
  icons: {
    icon: "/favicon.svg",
  },
};
