...
// and break recursive loops between Multiver instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-mv-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // Multiver instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another Multiver fetching our /models)
