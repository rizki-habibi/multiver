    ...
    <section className="py-24 border-y border-[#30363d] bg-[#161b22]/40" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-linear-to-r from-gray-700 via-[#58A6FF] to-gray-700 -z-10"></div>

          {/* Step 1: CLI & SDKs */}
          <div className="flex flex-col gap-6 relative group">
            <div className="w-24 h-24 rounded-2xl bg-[#0D1117] border border-[#30363d] flex items-center justify-center shadow-xl group-hover:border-gray-500 transition-colors z-10 mx-auto md:mx-0">
          ...
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-24 h-24 rounded-2xl bg-[#0D1117] border-2 border-[#58A6FF] flex items-center justify-center shadow-[0_0_30px_rgba(88,166,255,0.25)] z-10 mx-auto">
              <span className="material-symbols-outlined text-4xl text-[#58A6FF] animate-pulse">hub</span>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2 text-[#58A6FF]">2. Multiver Hub</h3>
              <p className="text-sm text-gray-400">
